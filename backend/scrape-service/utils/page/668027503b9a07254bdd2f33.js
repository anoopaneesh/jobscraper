...
export function getPage(count) { 
    return fetch("https://www.uber.com/api/loadSearchJobsResults?localeCode=en",{
  "headers": {
    "accept": "*/*",
  ...
  "body": `{\"params\":{\"location\":[{\"country\":\"IND\",\"region\":\"Maharashtra\",\"city\":\"Mumbai\"},{\"country\":\"IND\",\"region\":\"Karnataka\",\"city\":\"Bangalore\"},{\"country\":\"IND\",\"region\":\"Telangana\",\"city\":\"Hyderabad\"},{\"country\":\"IND\",\"region\":\"Haryana\",\"city\":\"Gurgaon\"},{\"country\":\"IND\",\"region\":\"Andhra Pradesh\",\"city\":\"Visakhapatnam\"}]},\"page\":${count-1},\"limit\":10}`,
  "method": "POST"
})
}
